...
def run(record: dict, repo_root: Path, coverage_record: Path | None) -> dict:
    ...
    # P1-1: isolate worker context from bulk parent context.
    ...
    # P0-4: untrusted readers cannot directly perform privileged actions.
    ...
    # P1-2: synthesize only after all expected structured child results arrive.
